<template>
    <div class="i-swipeout-wrap i-class"
        ...
        <div class="i-swipeout-item">
            ...
            <div class="i-swipeout-button-right-group" v-if="actions.length > 0">
            ...
            <div class="i-swipeout-button-right-group"  @click="handlerParentButton"  v-if="actions.length === 0" :style="{width: operateWidth +'px',right:'-'+operateWidth+'px'}">
