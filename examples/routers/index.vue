<template>
    <div>
        ...
        <nav>
            ...
            <ul>
                <li>
                    <router-link to="/Mobile/message">Mobile message</router-link>
                </li>
                <li>
                    <router-link to="/im-list">im-list列表</router-link>
                </li>
                <li>
                    <router-link to="/im-checkbox">im-checkbox复选</router-link>
                </li>
            </ul>
        </nav>
    </div>
